...
import { useRouter } from "expo-router"; // Cleaned up redundant router imports
      ...
      >
        <SafeAreaView style={styles.safeArea} edges={["top"]}>
          ...
          <View style={styles.bottomTabs}>
            <TabItem icon="home" label="Home" active onPress={() => router.push("/(freelancer-dashboard)/chat")} />
            ...
            {/* FIXED: The Chat Tab now navigates correctly */}
            <TabItem 
              icon="chatbubble-ellipses" 
              label="Chat" 
              onPress={() => router.push("/(freelancer-dashboard)/chat")} 
            />
...
// FIXED: Added 'onPress' to the TouchableOpacity so it actually reacts to taps
