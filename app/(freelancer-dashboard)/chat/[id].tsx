...
export default function ChatScreen() {
  const { id, name } = useLocalSearchParams(); // 'id' is the recipient
  ...
  // 2. Fetch messages & Subscribe when userId is available
  useEffect(() => {
    if (!userId) return;
  ...
  const sendMessage = async () => {
    ...
    // Optimistic UI update could go here, but let's keep it simple
          ...
          <View style={styles.header}>
            ...
            <View style={styles.headerInfo}>
              ...
              <View style={styles.onlineRow}>
                ...
                <Text style={styles.onlineText}>End-to-End Encrypted</Text>
              </View>
            </View>
              ...
              <FlatList
                ...
                ListEmptyComponent={() => (
                  <View style={styles.emptyContainer}>
                    <LinearGradient
                      colors={["rgba(56,189,248,0.15)", "rgba(14,165,233,0.05)"]}
                      style={styles.emptyIconWrapper}
                    >
                      <MaterialCommunityIcons name="shield-lock-outline" size={40} color="#38BDF8" />
                    </LinearGradient>
                    <Text style={styles.emptyTitle}>Secure Medical Chat</Text>
                    <Text style={styles.emptySub}>
                      Your consultation messages are private, encrypted and HIPAA-ready.
                    </Text>
                  </View>
                )}
...
// ... Styles remain the same as your code, but make sure to delete the 
// duplicate myMsgWrapper/theirMsgWrapper at the end of your styles object 
// that had green/grey colors to keep your modern theme.
